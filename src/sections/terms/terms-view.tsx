			...
			<Container maxWidth='lg'>
				<Stack direction='column' spacing={3}>
					...
					<Stack direction='column' spacing={1} sx={{ paddingLeft: '20px' }}>
						<SquaredText>1.1 Ця Угода користувача (далі – Угода) відноситься до сайту Інтернет-магазину «NVRMORE», розташованого за адресою https://theblackpearl.com.ua/, та до всіх відповідних сайтів, пов'язаних з сайтом www.theblackpearl.com.ua.</SquaredText>
						...
						<SquaredText>1.4 Ця Угода регулює відносини між Адміністрацією сайту Інтернет-магазину «NVRMORE» (далі – Адміністрація сайту) та Користувачем цього Сайту.</SquaredText>
				...
				<Stack direction='column' spacing={3}>
					...
					<Stack direction='column' spacing={1} sx={{ paddingLeft: '20px' }}>
						...
						<SquaredText>2.1.1 «NVRMORE» – Інтернет-магазин, розташований на доменному імені www.theblackpearl.com.ua, який здійснює свою діяльність за допомогою Інтернет-ресурсу та супутніх йому сервісів.</SquaredText>
