...
const SIMPLE_DATA = {
  ...
  children: [
    {
      ...createData('john stone', 'product-minimal design', 'lead', _mock.image.avatar(2)),
      children: [
        {
          ...createData('rimsha wynn', 'product-minimal design', 'senior', _mock.image.avatar(3)),
          children: null,
        },
      ],
    },
...
const DATA = {
  ...
  children: [
    {
      ...createData('product-minimal design', 'product-minimal design', null, null),
      children: [
        {
          ...createData('john stone', 'product-minimal design', 'lead', _mock.image.avatar(2)),
          children: [
