...
import { IArticleItem, IArticleTableFilters, IArticleTableFilterValue, STATUS_OPTIONS } from 'src/types/article';
...
import BlogTableFiltersResult from './blog-table-filters-result';
...
const defaultFilters: IArticleTableFilters = { search: '', status: 'all' };
...
export default function BlogListView() {
	...
	const handleEditRow = useCallback(
		(row: IArticleItem) => {
			openDrawer({ id: DrawerIds.BLOG_DRAWER_FORM, width: '768px' }, { Article: row });
		},
		[openDrawer],
	);
		...
		<>
			<Container maxWidth='lg'>
				...
				<Card>
					...
					<BlogTableToolbar filters={filters} onFilters={handleFilters} />

					{canReset && (
						<BlogTableFiltersResult
							filters={filters}
