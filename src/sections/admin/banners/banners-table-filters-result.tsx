...
import { IBannerTableFilters, IBannerTableFilterValue, STATUS_OPTIONS } from 'src/types/banner';

type Props = StackProps & {
  filters: IBannerTableFilters;
  onFilters: (name: string, value: IBannerTableFilterValue) => void;
  onResetFilters: VoidFunction;
  results: number;
};

export default function BannersTableFiltersResult({
  filters,
  onFilters,
  onResetFilters,
  results,
