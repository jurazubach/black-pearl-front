...
import { IProductTableFilters, STATUS_OPTIONS, IProductTableFilterValue, IProductItem } from 'src/types/product';
...
const defaultFilters: IProductTableFilters = { search: '', status: 'all' };
...
export default function ProductsListView() {
	...
	const onCreateClick = useCallback(() => openDrawer({
		id: DrawerIds.PRODUCT_DRAWER_FORM,
		width: '768px',
	}, {}), [openDrawer]);
	...
	const handleEditRow = useCallback(
		(row: IProductItem) => {
			openDrawer({ id: DrawerIds.PRODUCT_DRAWER_FORM, width: '768px' }, { Product: row });
		},
		[openDrawer],
	);
		...
		<>
			<Container maxWidth='lg'>
				...
				<Card>
					...
					<ProductsTableToolbar filters={filters} onFilters={handleFilters} />
